        ...
        if($loggedIn && $_SERVER["REQUEST_METHOD"] == "POST")
        {
            if(isset($_POST["submit"]))
            {
                ...
                */
                ...
                if($booking_added)
                {
                    ...
                    <strong>ສຳເລັດ!</strong> ການຈ່ອງໄດ້ບັນທຶກແລ້ວ
            ...
            if(isset($_POST["edit"]))
            {
                ...
                if(!$id_if_customer_exists || $customer_id == $id_if_customer_exists)
                {
                    ...
                    echo '<div class="my-0 alert alert-danger alert-dismissible fade show" role="alert">
                    <strong>ລົ້ມເຫຼວ!</strong> ແກໄຂຂໍ້ມູນບໍ່ສຳເລັດ
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>';
                }
        ...
        <?php
            ...
            if(!mysqli_num_rows($resultSqlResult)){ ?>
                ...
                <div class="container mt-4">
                    <div id="noCustomers" class="alert alert-dark " role="alert">
                        <h1 class="alert-heading">ບໍ່ພົບຂໍ້ມູນການຈ່ອງ!!</h1>
                        <p class="fw-light">ເພີ່ມຂໍ້ມູນເປັນຄົນທຳອິດ!</p>
                        <hr>
                        <div id="addCustomerAlert" class="alert alert-success" role="alert">
                                ຄລິກ <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">ເພີ່ມ <i class="fas fa-plus"></i></button> ເພື່ອເພີ່ມການຈ່ອງ!
                        </div>
                    </div>
                </div>
            <?php }
            ...
            <section id="booking">
                ...
                <div id="booking-results">
                    <div>
                        <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">ຈ່ອງປີ້ລົດເມ<i class="fas fa-plus"></i></button>
                    </div>
                    <table class="table table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            <button class="button btn-sm edit-button" data-link="<?php echo $_SERVER['REQUEST_URI']; ?>" data-customerid="<?php 
                                                ...
                                                echo $customer_phone;?>" >ແກ້ໄຂ</button>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-scrollable">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">ຈ່ອງປີ້ລົດເມ</h5>
                    ...
                    <div class="modal-body">
                        <form id="addBookingForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="cid" class="form-label">ລະຫັດຜູ້ໂດຍສານ</label>
                            ...
                            <div class="mb-3">
                                <label for="cname" class="form-label">ຊື່ລູກຄ້າ</label>
                            ...
                            <div class="mb-3">
                                <label for="route" class="form-label">ເສັ້ນທາງ</label>
                                <!-- Search Functionality -->
                                <div class="searchQuery">
                                    <input type="text" class="form-control searchInput" id="routeSearch" name="route">
                                    <div class="sugg">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                <label for="sourceSearch" class="form-label">ຕົ້ນທາງ</label>
                                <!-- Search Functionality -->
                                <div class="searchQuery">
                            ...
                            <div class="mb-3">
                                <label for="destinationSearch" class="form-label">ຈຸດໝາຍ</label>
                                <!-- Search Functionality -->
                                <div class="searchQuery">
                            ...
                            <div class="row g-3 align-items-center mb-3">
                                <div class="col-auto">
                                    <label for="seatInput" class="col-form-label">ເລກບ່ອນນັ່ງ</label>
                                </div>
                                <div class="col-auto">
                                ...
                                <div class="col-auto">
                                    ...
                                    ເລືອກບ່ອນນັ່ງໄດ້ພຽງຕຳແໜ່ງດຽວ.
                                    </span>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="bookAmount" class="form-label">ລວມລາຄາ</label>
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body">
                ...
                <p>
                    ທ່ານຕ້ອງການລຶບຂໍ້ມູນການຈອງນີ້ບໍ? <strong>ຂະບວນການບໍ່ສຳເລັດ.</strong>
                </p>
                <!-- Needed to pass id -->
