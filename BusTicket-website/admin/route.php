        ...
        */
        if($loggedIn && $_SERVER["REQUEST_METHOD"] == "POST")
        {
            if(isset($_POST["submit"]))
            {
                ...
                */
                ...
                if($route_added)
                {
                    ...
                    <strong>ສຳເລັດ!</strong> ຂະບວນລົດຖືກບັນທຶກແລ້ວ
                    ...
                    <strong>ຫຼົ້ມເຫຼວ!</strong> ຂະບວນລົດບັນທຶກບໍ່ສຳເລັດ
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>';
                }
            }
            if(isset($_POST["edit"]))
            {
                ...
                if(!$id_if_route_exists || $id == $id_if_route_exists)
                {
                    ...
                    elseif($updateResult)
                    {
                        ...
                        $messageInfo = "ຂະບວນລົດແກ້ໄຂສຳເລັດແລ້ວ";
                    }
                    else{
                        // Show error alert
            ...
            if(isset($_POST["delete"]))
            {
                ...
                {   
                    ...
                    // Show success alert
                    $messageStatus = "success";
                    $messageInfo = "ຂໍ້ມູນຂະບວນລົດເມໄດ້ຖືກລຶບແລ້ວ";
                    $messageHeading = "ສຳເລັດ!";
            ...
            if(!mysqli_num_rows($resultSqlResult)){ ?>
                ...
                <div class="container mt-4">
                    <div id="noRoutes" class="alert alert-dark " role="alert">
                        <h1 class="alert-heading">ບໍ່ພົບຂໍ້ມູນ!!</h1>
                        <p class="fw-light">ເພີ່ມເປັນຄົນທຳອິດ!</p>
                        <hr>
                        <div id="addRouteAlert" class="alert alert-success" role="alert">
                                ຄລິກ <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">ເພີ່ມ <i class="fas fa-plus"></i></button> ເພື່ອເພີ່ມຂໍ້ມູນລູກຄ້າ!
                        </div>
                    </div>
                </div>
            <?php }
                ...
                <section id="route">
                    <div id="head">
                        <h4>ສະຖານະຂະບວນລົດ</h4>
                    </div>
                    <div id="route-results">
                        <div>
                            <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">ເພີ່ມຂໍ້ມູນຂະບວນລົດ <i class="fas fa-plus"></i></button>
                        </div>
            ...
            <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">ເພີ່ມຂະບວນລົດ</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="addRouteForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                            <div class="mb-3">
                                    <label for="viaCities" class="form-label">ຕົ້ນທາງ-ປາຍທາງ</label>
                            ...
                            <div class="mb-3">
                                <label for="busno" class="form-label">ທະບຽນລົດເມ</label>
                            ...
                            <div class="mb-3">
                                <label for="stepCost" class="form-label">ລາຄາ</label>
                                <input type="number" class="form-control" id="stepCost" name="stepCost" required>
                            </div>
                            <div class="mb-3">
                                <label for="date" class="form-label">ວັນອອກລົດ</label>
                            ...
                            <div class="mb-3">
                                <label for="time" class="form-label">ເວລາອອກລົດ</label>
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body">
                ...
                <p>
                    ທ່ານຕ້ອງການລຶບຂໍ້ມູນຂະບວນລົດເມບໍ? <strong>ຂະບວນການບໍ່ສຳເລັດ.</strong>
                </p>
                <!-- Needed to pass id -->
