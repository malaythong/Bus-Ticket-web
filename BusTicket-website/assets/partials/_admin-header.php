...
<!-- <header>
    ...
    <main id="container">
        <div id="sidebar">
            <h4><i class="fas fa-bus"></i> ຄິວລົດເມຈຳປາ</h4>
            <div>
                ...
                <ul>
                    ...
                    <li class="welcome-item">
                        <button id="logout" class="btn-sm">
                            <a href="../assets/partials/_logout.php">ອອກຈາກລະບົບ</a>
                        </button>
                    </li>
                </ul>
            </section>