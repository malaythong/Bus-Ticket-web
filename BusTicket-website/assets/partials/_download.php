...
<div class="container">
        ...
        <div class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
            <div class="row">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 text-right">
                    ...
                    <p>
                        <em><b>ຈ່ອງໃນວັນທີ:</b> <br><?php echo $booked_timing; ?></em>
                    </p>
                </div>
            </div>
            <div class="row">
                <div class="text-center">
                    <h4><b>ລະຫັດປີ້ລົດເມ:</b> <?php echo $pnr; ?></h5>
                    <h2>ຂໍ້ມູນປີ້ລົດເມ</h2>
                </div>
                </span>
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>ຊື່ຜູ້ໂດຍສານ:</b></em></h4></td>
                        ...
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>ເບີໂທຜູ້ໂດຍສານ:</b></em></h4></td>
                        ...
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>ເສັ້ນທາງ:</b></em></h4></td>
                        ...
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>ທະບຽນລົດ:</b></em></h4></td>
                        ...
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>ຕຳແໜ່ງທີ່ນັ່ງ:</b></em></h4></td>
                        ...
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>ວັນອອກລົດ:</b></em></h4></td>
                        ...
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>ເວລາອອກລົດ:</b></em></h4></td>
    ...
    <div style="margin-top: 3rem;">    
        <button class="btn btn-primary">ປຣິ້ນ</button>
    </div>
